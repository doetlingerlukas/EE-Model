...
public final class PropertyServiceResource extends AbstractPropertyService {
	 ...
	 */
	public static Resource createResource(String id, ResourceType type) {
	 ...
	 */
	protected static void setResourceType(Resource res, ResourceType type) {
	 ...
	 */
	public static ResourceType getResourceType(Resource res) {
