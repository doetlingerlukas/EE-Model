...
public final class PropertyServiceResourceServerless extends AbstractPropertyService {
	 ...
	 */
	public static Resource createServerlessResource(String id, String resourceLink) {
		Resource result = new Resource(id);
	 ...
	 */
	public static String getUri(Resource res) {
		checkResource(res);
	 ...
	 */
	protected static void setUri(Resource res, String resourceLink) {
		checkResource(res);
	 ...
	 * @param res the provided resource.
	 */
	protected static void checkResource(Resource res) {
